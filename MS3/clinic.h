...
struct Phone {
    // need +1 for null terminator, if not it will repeat
...
// Todo:
void removeAppointment(struct Appointment* app, struct Patient* patients, int maxPatient);
//////////////////////////////////////
// UTILITY FUNCTIONS
//////////////////////////////////////
...
int validAppointment(int patientNumber, struct Date date, struct Appointment* app, int maxPatients);
